...
<jsp:useBean id="results"
             scope="session"
             class="ru.elina.entity.ResultsListBean"/>
<!DOCTYPE html>
<html  lang="ru">
<head>
    <meta charset="UTF-8">
...
<div class="plot">
    <svg height="300" width="300">
        <rect class="plot_part" x="150" y="50" height="100" width="50"></rect>
        <path class="plot_part" d="M150 150 L 100 150 C 100 200 150 200 150 200 L Z"></path>
        <polygon class="plot_part" points="200,150 150,150 150,200"></polygon>
...
<div class="footer">
    <div class="social">
        ...
        <a href="https://github.com/elinakrol" target="_blank"><img src="images/github.jpg" alt="GitHub"></a>
        <a href="https://vk.com/linakrol" target="_blank"><img src="images/vk.png" alt="VK"></a>
        <a href="https://telegram.me/elinaKrol" target="_blank"><img src="images/telegram.png" alt="Telegram"></a>
    </div>
    <br>
    © 2022 Elina Krol. All rights reserved.
    <br>
